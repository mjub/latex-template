...
In the first part of this century, Poincaré and other algebraic topologists utilized these concepts in their attempts to describe \q{$n$-dimensional holes} in simplicial complexes. Gradually people noticed that \q{vector space} could be replaced by \q{$R$-module} for any ring $R$.
...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \item The map $0 \to C_\cdot$ is a quasi-isomorphism, where \q{$0$} is the complex of zero modules and zero maps.
  \end{enumerate}
\end{exercise}
